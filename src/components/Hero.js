...
export default function Hero() {
  return (
    <section name='home'  className=" w-full  bg-indigo-100 flex md:flex-row flex-col pt-10 md:pt-[80px]">
        ...
        <div className=" fadein w-full md:w-2/5 h-full mt-20 pl-[5%] lg:pl-20 flex flex-col z-10 p-8 ">
          <h2 className=" text-3xl sm:text-6xl xl:text-[70px] lg:text-[50px] md:text-[40px] font-bold md:text-left text-center "> Awentis Webentwicklung</h2>
        ...
        <div className="fadeinOther diagonalBackground2 noDiagonal bg-indigo-200 md:bg-transparent p-[10%] md:p-0 w-full md:w-3/5 h-full  md:mt-20 z-10 flex justify-center">
